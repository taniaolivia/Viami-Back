        ...
        <body>
            <div style="font-family: Arial, sans-serif; text-align: justify; max-width: 600px; margin: 0 auto; background-color: #E5F3FF;">
                <div style="background-color: #0081CF; text-align: center; padding: 10px; color: white">
                    <img src="${process.env.CDN_URL}/assets/logo.png" style="width: 20px; height: auto"/>
                </div>
                ...
                <div style="padding: 5px 20px;">
                    ...
                    <a href="${process.env.API_URL}/verify?token=${token} style="text-decoration: none; margin: auto;">
                        <button style="color: white; background-color: #0081CF; border-radius: 10px; border: 1px solid #0081CF; padding: 10px 20px; font-weight: bold;">Vérifier mon e-mail</button>
                    </a>
